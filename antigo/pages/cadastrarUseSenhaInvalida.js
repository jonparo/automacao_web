...
async function cadastrarUseSenhaInvalida(driver) {
    ...
    await driver.findElement(By.name("passwordRegisterPage")).sendKeys("senha123");
    await driver.findElement(By.name("confirm_passwordRegisterPage")).sendKeys("senha123");
    await driver.findElement(By.name("emailRegisterPage")).sendKeys("exemplo@gmail.com");
    await preenchimentoCadastro(driver);
}

module.exports = cadastrarUseSenhaInvalida;